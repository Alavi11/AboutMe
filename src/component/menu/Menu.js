  ...
  return <div className={openmenu ? 'w-4/5 h-full z-40 bg-gray-900 fixed left-0 duration-700' : 'w-4/5 h-full bg-gray-900 fixed -left-full duration-700 z-40' }>
            ...
            <div className='w-full h-3/5 flex justify-start'>  
                <ul className='w-[40%] h-3/4 ml-5 flex justify-around flex-col-reverse'>
                    <HashLink smooth to='/#git'><li className='menuli flex justify-start text-gray-400 w-full cursor-pointer'><div className='lastch duration-500'><AiOutlineGithub className='mr-3' size={"20px"}/></div><p className=' duration-500 firstch'>Git</p></li></HashLink>
                    ...
                    <HashLink smooth to='/#home'><li className='menuli flex justify-start text-gray-400 w-full cursor-pointer'><div className='lastch duration-500'><AiOutlineHome className='mr-3' size={"20px"}/></div><p className='firstch duration-500'>Home</p></li></HashLink>
                </ul>
            </div>
