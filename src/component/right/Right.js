...
const Right = () => {
  ...
  return <div className="w-full h-full relative bg-right" id='home'>
        <div className='br1:left-[20%] br2:left-[25%] br3:left-[32%]  br4:top-[43%] absolute top-1/3 left-[10%] flex flex-col items-start text-white'>
            ...
            <p className='text-2xl ml-[3px] flex justify-start w-[330px] br:text-[18px]'>i'm <span className='ml-2 text-2xl border-b-[2.5px] border-[#149ddd] br:text-[20px]'>
              <Typewriter
                    onInit={(typewriter) => {
                        typewriter
              ...
              <span className='ml-1 text-2xl br:text-[18px]'>Developer</span>
            </p>
        </div>
