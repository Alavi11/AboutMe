...
const About = () => {
  ...
  return <div className='w-full h-[300vh] pt-5' id='about'>
            ...
            <div className='w-full'>
                <img src='../../../img/profile2.JPG' className='h-80 w-[90%] ml-[5%] mt-5'/>
                <div>
                    <h1 className='text-blue-950 text-3xl mt-8 ml-3'>Web Developer</h1>
                    <p className='mt-1 ml-3 w-[95%]'>
                        I have been working as a self-taught programmer for 2 years
                    </p>
                    <ul className='mt-3 pl-3 w-full list-disc h-80 flex flex-col-reverse justify-around'>
