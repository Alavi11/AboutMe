...
const Project = () => {
  ...
  return <div className='w-full h-[600px] br2:h-[700px] br4:pt-24 mt-1  br4:px-0' id='projects'>
            ...
            <div className='w-full flex flex-wrap gap-8  px-5 overflow-y-scroll mt-5'>
                ...
                <div data-aos="fade-right">
                    <a className='flex items-center' href='https://admin-panel-e.liara.run/'><BsCircleFill className='text-[10px] mr-1 text-[#149ddd]'/><p className='text-2xl'>Admin DashBoard</p></a>
