  ...
  return <div className='w-full h-[800px] br2:h-[700px] br4:pt-24 pt-5 overflow-x-hidden br4:px-0' id='projects'>
            ...
            <div className='w-full h-[80%] br2:h-[50%] flex flex-col-reverse br2:flex-row flex-wrap justify-around px-5 br2:mt-8'>
                <div data-aos="fade-right" className='br2:w-1/2'>
                    ...
                    <p className='ml-6 max-w-xs'>React, Axios , context are is used in the front part of the project and Node , Express , Mongoose and JWT and etc are used in the back part of the project and the structure of Access-Token and Refresh-Token is implemented .<br/>Routing and login sections and registration and restriction of routes have been done in this project</p>
                </div>
                <div data-aos="fade-right" className='br2:w-1/2'>
